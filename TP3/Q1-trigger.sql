...
-- Ce trigger ne fonctionne seulement a l'ajout d'un nouveau tuple, en effet le problème des tables mutantes(une table avec les nouveaux attribute et les anciens) posent problème a la modification
-- Un correctif pourrait être de modifier ce trigger en deux triggers disctinct un pour l'ajout de tuples et l'autre pour la modification de tuples.
